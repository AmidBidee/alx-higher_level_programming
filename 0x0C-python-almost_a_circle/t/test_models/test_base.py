...
class TestBaseClass(unittest.TestCase):
    ...
    def test_to_json_string_withNaN(self):
        ...
        self.assertEqual(str(e.exception), "list_dictionaries must be a list")
    ...
    def test_to_json_string_withinf(self):
        ...
        self.assertEqual(
            str(e.exception), "list_dictionaries must be a list")
            
    @unittest.skipUnless('save_to_file' in dir(Base), 'save_to_file not implemented yet')
    ...
    @unittest.skipUnless('from_json_string' in dir(Base), 
    'from_json_string not implemented yet')
    ...
    @unittest.skipUnless('load_from_file' in dir(Base),
    'load_from_file not implemented yet')
    ...
    @unittest.skipUnless('save_to_file' in dir(Base),
    'save_to_file not implemented yet')
    ...
    @unittest.skipUnless('to_json_string' in dir(Base),
    'to_json_string not implemented yet')
